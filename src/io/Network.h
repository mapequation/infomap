...
protected:
  ...
  void parseStateNetwork(const std::string& filename);
  void parseNetwork(const std::string& filename);
  void parseNetwork(std::string filename, const InsensitiveStringSet& validHeadings, const InsensitiveStringSet& ignoreHeadings, const std::string& startHeading = "");
   ...
   * Parse a bipartite network with the following format
    ...
    *Bipartite 4
    ...
    5 3
   */
  void parseBipartiteNetwork(const std::string& filename);
  void parseMultilayerNetwork(const std::string& filename);
