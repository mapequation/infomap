...
{
  std::string outputFilename = filename.empty() ? im.outDirectory + im.outName + (im.haveMemory() && states ? "_states.tree" : ".tree") : filename;
...
{
  std::string outputFilename = filename.empty() ? im.outDirectory + im.outName + (im.haveMemory() && states ? "_states.ftree" : ".ftree") : filename;
...
{
  std::string outputFilename = filename.empty() ? im.outDirectory + im.outName + (im.haveMemory() && states ? "_states.nwk" : ".nwk") : filename;
...
{
  std::string outputFilename = filename.empty() ? im.outDirectory + im.outName + (im.haveMemory() && states ? "_states.json" : ".json") : filename;
...
{
  std::string outputFilename = filename.empty() ? im.outDirectory + im.outName + (im.haveMemory() && states ? "_states.csv" : ".csv") : filename;
...
{
  std::string outputFilename = filename.empty() ? im.outDirectory + im.outName + (im.haveMemory() && states ? "_states.clu" : ".clu") : filename;
  SafeOutFile outFile(outputFilename);
