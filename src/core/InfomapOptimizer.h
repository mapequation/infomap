...
// 	InfomapOptimizer(bool forceNoMemory = false) : InfomapBase() { initMapEquation(forceNoMemory); }
// 	InfomapOptimizer(const Config& conf) : InfomapBase(conf) { initMapEquation(); }
...
// protected:
// 	InfomapOptimizer& initMapEquation(bool forceNoMemory = false)
// 	{
// 		if (this->haveMemory() && !forceNoMemory) {
...
// inline
// bool InfomapOptimizer::haveMemory() const {
// 	return m_objective->haveMemory();
// }

// inline
// InfomapBase* InfomapOptimizer::getNewInfomapInstance() const {
// 	return new InfomapOptimizer();
// }

// inline
// InfomapBase* InfomapOptimizer::getNewInfomapInstanceWithoutMemory() const {
// 	return new InfomapOptimizer(true);
// }

// inline
// double InfomapOptimizer::getCodelength() const
// {
// 	return m_objective->codelength;
// }

// inline
// double InfomapOptimizer::getIndexCodelength() const
// {
// 	return m_objective->indexCodelength;
// }

// inline
// double InfomapOptimizer::getModuleCodelength() const
// {
// 	return m_objective->moduleCodelength;
// }

// inline
// unsigned int InfomapOptimizer::numActiveModules() const
// {
...
// inline
// void InfomapOptimizer::initNetwork()
// {
...
// inline
// void InfomapOptimizer::initSuperNetwork()
// {
...
// inline
// double InfomapOptimizer::calcCodelength(const InfoNode& parent) const
// {
...
// void InfomapOptimizer::initPartition()
// {
...
// void InfomapOptimizer::moveActiveNodesToPredifinedModules(std::vector<unsigned int>& modules)
// {
// 	auto& network = activeNetwork();
// 	unsigned int numNodes = network.size();
...
// inline
// unsigned int InfomapOptimizer::optimizeActiveNetwork()
// {
...
// // unsigned int InfomapOptimizer::tryMoveEachNodeIntoBestModuleLocal()
// // {
...
// unsigned int InfomapOptimizer::tryMoveEachNodeIntoBestModule()
// {
// 	// m_rand.seed(123);
// 	// Get random enumeration of nodes
// 	std::vector<unsigned int> nodeEnumeration(activeNetwork().size());
...
//  */
// unsigned int InfomapOptimizer::tryMoveEachNodeIntoBestModuleInParallel()
// {
// 	// Get random enumeration of nodes
// 	std::vector<unsigned int> nodeEnumeration(activeNetwork().size());
// 	m_rand.getRandomizedIndexVector(nodeEnumeration);
...
// inline
// void InfomapOptimizer::consolidateModules(bool replaceExistingModules)
// {
...
// 	m_consolidatedObjective = MapEquationPtr(m_objective->clone());
// }

// inline
// bool InfomapOptimizer::restoreConsolidatedOptimizationPointIfNoImprovement(bool forceRestore)
// {
// 	if (forceRestore || m_objective->codelength >= m_consolidatedObjective->codelength - this->minimumSingleNodeCodelengthImprovement)
// 	{
// 		m_objective = MapEquationPtr(m_consolidatedObjective->clone());
// 		return true;
// 	}
// 	return false;
// }
...
// std::ostream& InfomapOptimizer::toString(std::ostream& out) const
// {
...
// inline
// void InfomapOptimizer::printDebug()
// {
