...
public:
	...
	bool haveDirectedInput() const { return m_directedInput; }

	void printNetwork() const;

protected:
	void haveDirectedInput(bool directed) {
		m_directedInput = directed;
		m_config.directed = true;
	}
