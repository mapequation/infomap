...
Maintainers usually handle runtime, algorithmic, numerical, determinism,
memory, release, and broad cross-surface changes directly. If you are unsure
whether a change fits, start with an issue or discussion instead of a pull
request.
...
- `RELEASING.md` before you touch release or publishing behavior, and for the
  Python API deprecation policy before you deprecate or remove public names
