...
class InfoNode(object):
    ...
    parent = property(_infomap.InfoNode_parent_get)
    previous = property(_infomap.InfoNode_previous_get)
    next = property(_infomap.InfoNode_next_get)
    firstChild = property(_infomap.InfoNode_firstChild_get)
    lastChild = property(_infomap.InfoNode_lastChild_get)
    collapsedFirstChild = property(_infomap.InfoNode_collapsedFirstChild_get)
    collapsedLastChild = property(_infomap.InfoNode_collapsedLastChild_get)
...
class InfomapIterator(object):
    ...
    parent = property(_infomap.InfomapIterator_parent_get)
    previous = property(_infomap.InfomapIterator_previous_get)
    next = property(_infomap.InfomapIterator_next_get)
    firstChild = property(_infomap.InfomapIterator_firstChild_get)
    lastChild = property(_infomap.InfomapIterator_lastChild_get)
    collapsedFirstChild = property(_infomap.InfomapIterator_collapsedFirstChild_get)
    collapsedLastChild = property(_infomap.InfomapIterator_collapsedLastChild_get)
...
class InfomapParentIterator(object):
    ...
    parent = property(_infomap.InfomapParentIterator_parent_get)
    previous = property(_infomap.InfomapParentIterator_previous_get)
    next = property(_infomap.InfomapParentIterator_next_get)
    firstChild = property(_infomap.InfomapParentIterator_firstChild_get)
    lastChild = property(_infomap.InfomapParentIterator_lastChild_get)
    collapsedFirstChild = property(_infomap.InfomapParentIterator_collapsedFirstChild_get)
    collapsedLastChild = property(_infomap.InfomapParentIterator_collapsedLastChild_get)
