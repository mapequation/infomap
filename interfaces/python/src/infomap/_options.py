...
_OPTION_TABLE = {
    ...
    "output": _OptionSpec("--output", "comma_list", None, choices=("clu", "tree", "ftree", "newick", "json", "csv", "network", "states", "flow",), action="args-only", replacement="Use Result.write_tree/write_flow_tree/write_clu (write_clu takes depth) or Network.write_pajek/write_state_network. The flag only acts when an output directory is passed via the raw args escape hatch."),
    # algorithm
    "two_level": _OptionSpec("--two-level", "flag", False, common=True),
    "flow_model": _OptionSpec("--flow-model", "value", None, choices=("undirected", "directed", "undirdir", "outdirdir", "rawdir", "precomputed",)),
