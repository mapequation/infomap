...
setClass("infomap::Config",
    representation(
        ...
        twoLevel = "logical",
        refineBeforeAggregation = "logical",
        refineMinModuleSize = "integer",
        refineStartMode = "character",
...
# Start of Config_refineBeforeAggregation_set

`Config_refineBeforeAggregation_set` = function(self, s_refineBeforeAggregation)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_refineBeforeAggregation = as.logical(s_refineBeforeAggregation);
  ;.Call('R_swig_Config_refineBeforeAggregation_set', self, s_refineBeforeAggregation, PACKAGE='infomap');
  
}

attr(`Config_refineBeforeAggregation_set`, 'returnType') = 'void'
attr(`Config_refineBeforeAggregation_set`, "inputTypes") = c('_p_infomap__Config', 'logical')
class(`Config_refineBeforeAggregation_set`) = c("SWIGFunction", class('Config_refineBeforeAggregation_set'))

# Start of Config_refineBeforeAggregation_get

`Config_refineBeforeAggregation_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_refineBeforeAggregation_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_refineBeforeAggregation_get`, 'returnType') = 'logical'
attr(`Config_refineBeforeAggregation_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_refineBeforeAggregation_get`) = c("SWIGFunction", class('Config_refineBeforeAggregation_get'))

# Start of Config_refineMinModuleSize_set

`Config_refineMinModuleSize_set` = function(self, s_refineMinModuleSize)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_refineMinModuleSize = as.integer(s_refineMinModuleSize);
  
  if(length(s_refineMinModuleSize) > 1) {
    warning("using only the first element of s_refineMinModuleSize");
  };
  
  ;.Call('R_swig_Config_refineMinModuleSize_set', self, s_refineMinModuleSize, PACKAGE='infomap');
  
}

attr(`Config_refineMinModuleSize_set`, 'returnType') = 'void'
attr(`Config_refineMinModuleSize_set`, "inputTypes") = c('_p_infomap__Config', 'integer')
class(`Config_refineMinModuleSize_set`) = c("SWIGFunction", class('Config_refineMinModuleSize_set'))

# Start of Config_refineMinModuleSize_get

`Config_refineMinModuleSize_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_refineMinModuleSize_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_refineMinModuleSize_get`, 'returnType') = 'integer'
attr(`Config_refineMinModuleSize_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_refineMinModuleSize_get`) = c("SWIGFunction", class('Config_refineMinModuleSize_get'))

# Start of Config_refineStartMode_set

`Config_refineStartMode_set` = function(self, s_refineStartMode)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_refineStartMode = as(s_refineStartMode, "character"); 
  ;.Call('R_swig_Config_refineStartMode_set', self, s_refineStartMode, PACKAGE='infomap');
  
}

attr(`Config_refineStartMode_set`, 'returnType') = 'void'
attr(`Config_refineStartMode_set`, "inputTypes") = c('_p_infomap__Config', 'character')
class(`Config_refineStartMode_set`) = c("SWIGFunction", class('Config_refineStartMode_set'))

# Start of Config_refineStartMode_get

`Config_refineStartMode_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_refineStartMode_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_refineStartMode_get`, 'returnType') = 'character'
attr(`Config_refineStartMode_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_refineStartMode_get`) = c("SWIGFunction", class('Config_refineStartMode_get'))
...
CopyToR_infomap__Config = function(value, obj = new("infomap::Config"))
{
  ...
  obj@refineBeforeAggregation = value$refineBeforeAggregation;
  obj@refineMinModuleSize = value$refineMinModuleSize;
  obj@refineStartMode = value$refineStartMode;
...
# Start of InfomapConfigInfomapBase_setRefineBeforeAggregation

`InfomapConfigInfomapBase_setRefineBeforeAggregation` = function(self, value, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  value = as.logical(value);
  ;ans = .Call('R_swig_InfomapConfigInfomapBase_setRefineBeforeAggregation', self, value, as.logical(.copy), PACKAGE='infomap');
  ans <- if (is.null(ans)) ans
  else new("_p_infomap__InfomapBase", ref=ans);
...
attr(`InfomapConfigInfomapBase_setRefineBeforeAggregation`, 'returnType') = '_p_infomap__InfomapBase'
attr(`InfomapConfigInfomapBase_setRefineBeforeAggregation`, "inputTypes") = c('_p_infomap__InfomapConfigT_infomap__InfomapBase_t', 'logical')
class(`InfomapConfigInfomapBase_setRefineBeforeAggregation`) = c("SWIGFunction", class('InfomapConfigInfomapBase_setRefineBeforeAggregation'))

# Start of InfomapConfigInfomapBase_setRefineMinModuleSize

`InfomapConfigInfomapBase_setRefineMinModuleSize` = function(self, value, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  value = as.integer(value);
  ...
  ;ans = .Call('R_swig_InfomapConfigInfomapBase_setRefineMinModuleSize', self, value, as.logical(.copy), PACKAGE='infomap');
  ans <- if (is.null(ans)) ans
  else new("_p_infomap__InfomapBase", ref=ans);
...
attr(`InfomapConfigInfomapBase_setRefineMinModuleSize`, 'returnType') = '_p_infomap__InfomapBase'
attr(`InfomapConfigInfomapBase_setRefineMinModuleSize`, "inputTypes") = c('_p_infomap__InfomapConfigT_infomap__InfomapBase_t', 'integer')
class(`InfomapConfigInfomapBase_setRefineMinModuleSize`) = c("SWIGFunction", class('InfomapConfigInfomapBase_setRefineMinModuleSize'))

# Start of InfomapConfigInfomapBase_setRefineStartMode

`InfomapConfigInfomapBase_setRefineStartMode` = function(self, value, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  value = as(value, "character"); 
  ;ans = .Call('R_swig_InfomapConfigInfomapBase_setRefineStartMode', self, value, as.logical(.copy), PACKAGE='infomap');
  ans <- if (is.null(ans)) ans
  else new("_p_infomap__InfomapBase", ref=ans);
...
attr(`InfomapConfigInfomapBase_setRefineStartMode`, 'returnType') = '_p_infomap__InfomapBase'
attr(`InfomapConfigInfomapBase_setRefineStartMode`, "inputTypes") = c('_p_infomap__InfomapConfigT_infomap__InfomapBase_t', 'character')
class(`InfomapConfigInfomapBase_setRefineStartMode`) = c("SWIGFunction", class('InfomapConfigInfomapBase_setRefineStartMode'))
