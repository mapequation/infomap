...
setClass("infomap::Config",
    representation(
        ...
        minFlowIterations = "integer",
        flowTolerance = "numeric",
        twoLevel = "logical",
        ...
        hierFromBlocks = "logical",
        columnarCheck = "logical",
        columnarTwoLevel = "logical",
        columnarSearch = "logical",
        nonRedundant = "logical",
        nonRedundantExact = "logical",
...
# Start of Config_minFlowIterations_set

`Config_minFlowIterations_set` = function(self, s_minFlowIterations)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_minFlowIterations = as.integer(s_minFlowIterations);
  
  if(length(s_minFlowIterations) > 1) {
    warning("using only the first element of s_minFlowIterations");
  };
  
  ;.Call('R_swig_Config_minFlowIterations_set', self, s_minFlowIterations, PACKAGE='infomap');
  
}

attr(`Config_minFlowIterations_set`, 'returnType') = 'void'
attr(`Config_minFlowIterations_set`, "inputTypes") = c('_p_infomap__Config', 'integer')
class(`Config_minFlowIterations_set`) = c("SWIGFunction", class('Config_minFlowIterations_set'))

# Start of Config_minFlowIterations_get

`Config_minFlowIterations_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_minFlowIterations_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_minFlowIterations_get`, 'returnType') = 'integer'
attr(`Config_minFlowIterations_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_minFlowIterations_get`) = c("SWIGFunction", class('Config_minFlowIterations_get'))

# Start of Config_flowTolerance_set

`Config_flowTolerance_set` = function(self, s_flowTolerance)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  
  ;.Call('R_swig_Config_flowTolerance_set', self, s_flowTolerance, PACKAGE='infomap');
  
}

attr(`Config_flowTolerance_set`, 'returnType') = 'void'
attr(`Config_flowTolerance_set`, "inputTypes") = c('_p_infomap__Config', 'numeric')
class(`Config_flowTolerance_set`) = c("SWIGFunction", class('Config_flowTolerance_set'))

# Start of Config_flowTolerance_get

`Config_flowTolerance_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_flowTolerance_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_flowTolerance_get`, 'returnType') = 'numeric'
attr(`Config_flowTolerance_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_flowTolerance_get`) = c("SWIGFunction", class('Config_flowTolerance_get'))
...
# Start of Config_hierFromBlocks_set

`Config_hierFromBlocks_set` = function(self, s_hierFromBlocks)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_hierFromBlocks = as.logical(s_hierFromBlocks);
  ;.Call('R_swig_Config_hierFromBlocks_set', self, s_hierFromBlocks, PACKAGE='infomap');
  
}

attr(`Config_hierFromBlocks_set`, 'returnType') = 'void'
attr(`Config_hierFromBlocks_set`, "inputTypes") = c('_p_infomap__Config', 'logical')
class(`Config_hierFromBlocks_set`) = c("SWIGFunction", class('Config_hierFromBlocks_set'))

# Start of Config_hierFromBlocks_get

`Config_hierFromBlocks_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_hierFromBlocks_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_hierFromBlocks_get`, 'returnType') = 'logical'
attr(`Config_hierFromBlocks_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_hierFromBlocks_get`) = c("SWIGFunction", class('Config_hierFromBlocks_get'))

# Start of Config_columnarCheck_set

`Config_columnarCheck_set` = function(self, s_columnarCheck)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_columnarCheck = as.logical(s_columnarCheck);
  ;.Call('R_swig_Config_columnarCheck_set', self, s_columnarCheck, PACKAGE='infomap');
  
}

attr(`Config_columnarCheck_set`, 'returnType') = 'void'
attr(`Config_columnarCheck_set`, "inputTypes") = c('_p_infomap__Config', 'logical')
class(`Config_columnarCheck_set`) = c("SWIGFunction", class('Config_columnarCheck_set'))

# Start of Config_columnarCheck_get

`Config_columnarCheck_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_columnarCheck_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_columnarCheck_get`, 'returnType') = 'logical'
attr(`Config_columnarCheck_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_columnarCheck_get`) = c("SWIGFunction", class('Config_columnarCheck_get'))

# Start of Config_columnarTwoLevel_set

`Config_columnarTwoLevel_set` = function(self, s_columnarTwoLevel)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_columnarTwoLevel = as.logical(s_columnarTwoLevel);
  ;.Call('R_swig_Config_columnarTwoLevel_set', self, s_columnarTwoLevel, PACKAGE='infomap');
  
}

attr(`Config_columnarTwoLevel_set`, 'returnType') = 'void'
attr(`Config_columnarTwoLevel_set`, "inputTypes") = c('_p_infomap__Config', 'logical')
class(`Config_columnarTwoLevel_set`) = c("SWIGFunction", class('Config_columnarTwoLevel_set'))

# Start of Config_columnarTwoLevel_get

`Config_columnarTwoLevel_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_columnarTwoLevel_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_columnarTwoLevel_get`, 'returnType') = 'logical'
attr(`Config_columnarTwoLevel_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_columnarTwoLevel_get`) = c("SWIGFunction", class('Config_columnarTwoLevel_get'))

# Start of Config_columnarSearch_set

`Config_columnarSearch_set` = function(self, s_columnarSearch)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_columnarSearch = as.logical(s_columnarSearch);
  ;.Call('R_swig_Config_columnarSearch_set', self, s_columnarSearch, PACKAGE='infomap');
  
}

attr(`Config_columnarSearch_set`, 'returnType') = 'void'
attr(`Config_columnarSearch_set`, "inputTypes") = c('_p_infomap__Config', 'logical')
class(`Config_columnarSearch_set`) = c("SWIGFunction", class('Config_columnarSearch_set'))

# Start of Config_columnarSearch_get

`Config_columnarSearch_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_columnarSearch_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_columnarSearch_get`, 'returnType') = 'logical'
attr(`Config_columnarSearch_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_columnarSearch_get`) = c("SWIGFunction", class('Config_columnarSearch_get'))

# Start of Config_nonRedundant_set

`Config_nonRedundant_set` = function(self, s_nonRedundant)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_nonRedundant = as.logical(s_nonRedundant);
  ;.Call('R_swig_Config_nonRedundant_set', self, s_nonRedundant, PACKAGE='infomap');
  
}

attr(`Config_nonRedundant_set`, 'returnType') = 'void'
attr(`Config_nonRedundant_set`, "inputTypes") = c('_p_infomap__Config', 'logical')
class(`Config_nonRedundant_set`) = c("SWIGFunction", class('Config_nonRedundant_set'))

# Start of Config_nonRedundant_get

`Config_nonRedundant_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_nonRedundant_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_nonRedundant_get`, 'returnType') = 'logical'
attr(`Config_nonRedundant_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_nonRedundant_get`) = c("SWIGFunction", class('Config_nonRedundant_get'))

# Start of Config_nonRedundantExact_set

`Config_nonRedundantExact_set` = function(self, s_nonRedundantExact)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_nonRedundantExact = as.logical(s_nonRedundantExact);
  ;.Call('R_swig_Config_nonRedundantExact_set', self, s_nonRedundantExact, PACKAGE='infomap');
  
}

attr(`Config_nonRedundantExact_set`, 'returnType') = 'void'
attr(`Config_nonRedundantExact_set`, "inputTypes") = c('_p_infomap__Config', 'logical')
class(`Config_nonRedundantExact_set`) = c("SWIGFunction", class('Config_nonRedundantExact_set'))

# Start of Config_nonRedundantExact_get

`Config_nonRedundantExact_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_nonRedundantExact_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_nonRedundantExact_get`, 'returnType') = 'logical'
attr(`Config_nonRedundantExact_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_nonRedundantExact_get`) = c("SWIGFunction", class('Config_nonRedundantExact_get'))
...
CopyToR_infomap__Config = function(value, obj = new("infomap::Config"))
{
  ...
  obj@minFlowIterations = value$minFlowIterations;
  obj@flowTolerance = value$flowTolerance;
  ...
  obj@hierFromBlocks = value$hierFromBlocks;
  obj@columnarCheck = value$columnarCheck;
  obj@columnarTwoLevel = value$columnarTwoLevel;
  obj@columnarSearch = value$columnarSearch;
  obj@nonRedundant = value$nonRedundant;
  obj@nonRedundantExact = value$nonRedundantExact;
