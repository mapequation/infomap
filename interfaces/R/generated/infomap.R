...
setClass('_p_infomap__NodeData', contains = 'C++Reference')
setClass("infomap::NodeData",
    representation(
        node_id = "integer",
        state_id = "integer",
        module_id = "integer",
        ...
        layer_id = "integer",
        child_index = "integer",
        modular_centrality = "numeric",
        path_flat = "integer",
        path_len = "integer"),
        contains = "RSWIGStruct")


# End class infomap::NodeData
...
# Start of Config_convergeTrials_set

`Config_convergeTrials_set` = function(self, s_convergeTrials)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_convergeTrials = as.logical(s_convergeTrials);
  ;.Call('R_swig_Config_convergeTrials_set', self, s_convergeTrials, PACKAGE='infomap');
  
}

attr(`Config_convergeTrials_set`, 'returnType') = 'void'
attr(`Config_convergeTrials_set`, "inputTypes") = c('_p_infomap__Config', 'logical')
class(`Config_convergeTrials_set`) = c("SWIGFunction", class('Config_convergeTrials_set'))

# Start of Config_convergeTrials_get

`Config_convergeTrials_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_convergeTrials_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_convergeTrials_get`, 'returnType') = 'logical'
attr(`Config_convergeTrials_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_convergeTrials_get`) = c("SWIGFunction", class('Config_convergeTrials_get'))
...
CopyToR_infomap__Config = function(value, obj = new("infomap::Config"))
{
  ...
  obj@convergeTrials = value$convergeTrials;
...
# Start of InfomapBase_setMultilayerInitialPartition

`InfomapBase_setMultilayerInitialPartition` = function(self, layerIds, nodeIds, moduleIds, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  layerIds = as.integer(layerIds);
  nodeIds = as.integer(nodeIds);
  moduleIds = as.integer(moduleIds);
  ;ans = .Call('R_swig_InfomapBase_setMultilayerInitialPartition', self, layerIds, nodeIds, moduleIds, as.logical(.copy), PACKAGE='infomap');
  ans <- if (is.null(ans)) ans
  else new("_p_infomap__InfomapBase", ref=ans);
...
attr(`InfomapBase_setMultilayerInitialPartition`, 'returnType') = '_p_infomap__InfomapBase'
attr(`InfomapBase_setMultilayerInitialPartition`, "inputTypes") = c('_p_infomap__InfomapBase', 'integer', 'integer', 'integer')
class(`InfomapBase_setMultilayerInitialPartition`) = c("SWIGFunction", class('InfomapBase_setMultilayerInitialPartition'))
...
# Start of NodeData_node_id_set

`NodeData_node_id_set` = function(self, s_node_id)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_node_id = as.integer(s_node_id);
  ;.Call('R_swig_NodeData_node_id_set', self, s_node_id, PACKAGE='infomap');
  
}

attr(`NodeData_node_id_set`, 'returnType') = 'void'
attr(`NodeData_node_id_set`, "inputTypes") = c('_p_infomap__NodeData', 'integer')
class(`NodeData_node_id_set`) = c("SWIGFunction", class('NodeData_node_id_set'))

# Start of NodeData_node_id_get

`NodeData_node_id_get` = function(self)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_NodeData_node_id_get', self, PACKAGE='infomap');
  
}

attr(`NodeData_node_id_get`, 'returnType') = 'integer'
attr(`NodeData_node_id_get`, "inputTypes") = c('_p_infomap__NodeData')
class(`NodeData_node_id_get`) = c("SWIGFunction", class('NodeData_node_id_get'))

# Start of NodeData_state_id_set

`NodeData_state_id_set` = function(self, s_state_id)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_state_id = as.integer(s_state_id);
  ;.Call('R_swig_NodeData_state_id_set', self, s_state_id, PACKAGE='infomap');
  
}

attr(`NodeData_state_id_set`, 'returnType') = 'void'
attr(`NodeData_state_id_set`, "inputTypes") = c('_p_infomap__NodeData', 'integer')
class(`NodeData_state_id_set`) = c("SWIGFunction", class('NodeData_state_id_set'))

# Start of NodeData_state_id_get

`NodeData_state_id_get` = function(self)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_NodeData_state_id_get', self, PACKAGE='infomap');
  
}

attr(`NodeData_state_id_get`, 'returnType') = 'integer'
attr(`NodeData_state_id_get`, "inputTypes") = c('_p_infomap__NodeData')
class(`NodeData_state_id_get`) = c("SWIGFunction", class('NodeData_state_id_get'))

# Start of NodeData_module_id_set

`NodeData_module_id_set` = function(self, s_module_id)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_module_id = as.integer(s_module_id);
  ;.Call('R_swig_NodeData_module_id_set', self, s_module_id, PACKAGE='infomap');
  
}

attr(`NodeData_module_id_set`, 'returnType') = 'void'
attr(`NodeData_module_id_set`, "inputTypes") = c('_p_infomap__NodeData', 'integer')
class(`NodeData_module_id_set`) = c("SWIGFunction", class('NodeData_module_id_set'))

# Start of NodeData_module_id_get

`NodeData_module_id_get` = function(self)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_NodeData_module_id_get', self, PACKAGE='infomap');
  
}

attr(`NodeData_module_id_get`, 'returnType') = 'integer'
attr(`NodeData_module_id_get`, "inputTypes") = c('_p_infomap__NodeData')
class(`NodeData_module_id_get`) = c("SWIGFunction", class('NodeData_module_id_get'))
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_flow = as.numeric(s_flow);
  ;.Call('R_swig_NodeData_flow_set', self, s_flow, PACKAGE='infomap');
  
}

attr(`NodeData_flow_set`, 'returnType') = 'void'
attr(`NodeData_flow_set`, "inputTypes") = c('_p_infomap__NodeData', '_p_std__vectorT_double_t')
class(`NodeData_flow_set`) = c("SWIGFunction", class('NodeData_flow_set'))

# Start of NodeData_flow_get

`NodeData_flow_get` = function(self)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_NodeData_flow_get', self, PACKAGE='infomap');
  
}

attr(`NodeData_flow_get`, 'returnType') = '_p_std__vectorT_double_t'
attr(`NodeData_flow_get`, "inputTypes") = c('_p_infomap__NodeData')
class(`NodeData_flow_get`) = c("SWIGFunction", class('NodeData_flow_get'))

# Start of NodeData_depth_set

`NodeData_depth_set` = function(self, s_depth)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_depth = as.integer(s_depth);
  ;.Call('R_swig_NodeData_depth_set', self, s_depth, PACKAGE='infomap');
  
}

attr(`NodeData_depth_set`, 'returnType') = 'void'
attr(`NodeData_depth_set`, "inputTypes") = c('_p_infomap__NodeData', 'integer')
class(`NodeData_depth_set`) = c("SWIGFunction", class('NodeData_depth_set'))

# Start of NodeData_depth_get

`NodeData_depth_get` = function(self)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_NodeData_depth_get', self, PACKAGE='infomap');
  
}

attr(`NodeData_depth_get`, 'returnType') = 'integer'
attr(`NodeData_depth_get`, "inputTypes") = c('_p_infomap__NodeData')
class(`NodeData_depth_get`) = c("SWIGFunction", class('NodeData_depth_get'))

# Start of NodeData_layer_id_set

`NodeData_layer_id_set` = function(self, s_layer_id)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_layer_id = as.integer(s_layer_id);
  ;.Call('R_swig_NodeData_layer_id_set', self, s_layer_id, PACKAGE='infomap');
  
}

attr(`NodeData_layer_id_set`, 'returnType') = 'void'
attr(`NodeData_layer_id_set`, "inputTypes") = c('_p_infomap__NodeData', 'integer')
class(`NodeData_layer_id_set`) = c("SWIGFunction", class('NodeData_layer_id_set'))

# Start of NodeData_layer_id_get

`NodeData_layer_id_get` = function(self)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_NodeData_layer_id_get', self, PACKAGE='infomap');
  
}

attr(`NodeData_layer_id_get`, 'returnType') = 'integer'
attr(`NodeData_layer_id_get`, "inputTypes") = c('_p_infomap__NodeData')
class(`NodeData_layer_id_get`) = c("SWIGFunction", class('NodeData_layer_id_get'))

# Start of NodeData_child_index_set

`NodeData_child_index_set` = function(self, s_child_index)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_child_index = as.integer(s_child_index);
  ;.Call('R_swig_NodeData_child_index_set', self, s_child_index, PACKAGE='infomap');
  
}

attr(`NodeData_child_index_set`, 'returnType') = 'void'
attr(`NodeData_child_index_set`, "inputTypes") = c('_p_infomap__NodeData', 'integer')
class(`NodeData_child_index_set`) = c("SWIGFunction", class('NodeData_child_index_set'))

# Start of NodeData_child_index_get

`NodeData_child_index_get` = function(self)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_NodeData_child_index_get', self, PACKAGE='infomap');
  
}

attr(`NodeData_child_index_get`, 'returnType') = 'integer'
attr(`NodeData_child_index_get`, "inputTypes") = c('_p_infomap__NodeData')
class(`NodeData_child_index_get`) = c("SWIGFunction", class('NodeData_child_index_get'))

# Start of NodeData_modular_centrality_set

`NodeData_modular_centrality_set` = function(self, s_modular_centrality)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_modular_centrality = as.numeric(s_modular_centrality);
  ;.Call('R_swig_NodeData_modular_centrality_set', self, s_modular_centrality, PACKAGE='infomap');
  
}

attr(`NodeData_modular_centrality_set`, 'returnType') = 'void'
attr(`NodeData_modular_centrality_set`, "inputTypes") = c('_p_infomap__NodeData', '_p_std__vectorT_double_t')
class(`NodeData_modular_centrality_set`) = c("SWIGFunction", class('NodeData_modular_centrality_set'))

# Start of NodeData_modular_centrality_get

`NodeData_modular_centrality_get` = function(self)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_NodeData_modular_centrality_get', self, PACKAGE='infomap');
  
}

attr(`NodeData_modular_centrality_get`, 'returnType') = '_p_std__vectorT_double_t'
attr(`NodeData_modular_centrality_get`, "inputTypes") = c('_p_infomap__NodeData')
class(`NodeData_modular_centrality_get`) = c("SWIGFunction", class('NodeData_modular_centrality_get'))

# Start of NodeData_path_flat_set

`NodeData_path_flat_set` = function(self, s_path_flat)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_path_flat = as.integer(s_path_flat);
  ;.Call('R_swig_NodeData_path_flat_set', self, s_path_flat, PACKAGE='infomap');
  
}

attr(`NodeData_path_flat_set`, 'returnType') = 'void'
attr(`NodeData_path_flat_set`, "inputTypes") = c('_p_infomap__NodeData', 'integer')
class(`NodeData_path_flat_set`) = c("SWIGFunction", class('NodeData_path_flat_set'))

# Start of NodeData_path_flat_get

`NodeData_path_flat_get` = function(self)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_NodeData_path_flat_get', self, PACKAGE='infomap');
  
}

attr(`NodeData_path_flat_get`, 'returnType') = 'integer'
attr(`NodeData_path_flat_get`, "inputTypes") = c('_p_infomap__NodeData')
class(`NodeData_path_flat_get`) = c("SWIGFunction", class('NodeData_path_flat_get'))

# Start of NodeData_path_len_set

`NodeData_path_len_set` = function(self, s_path_len)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_path_len = as.integer(s_path_len);
  ;.Call('R_swig_NodeData_path_len_set', self, s_path_len, PACKAGE='infomap');
  
}

attr(`NodeData_path_len_set`, 'returnType') = 'void'
attr(`NodeData_path_len_set`, "inputTypes") = c('_p_infomap__NodeData', 'integer')
class(`NodeData_path_len_set`) = c("SWIGFunction", class('NodeData_path_len_set'))

# Start of NodeData_path_len_get

`NodeData_path_len_get` = function(self)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_NodeData_path_len_get', self, PACKAGE='infomap');
  
}

attr(`NodeData_path_len_get`, 'returnType') = 'integer'
attr(`NodeData_path_len_get`, "inputTypes") = c('_p_infomap__NodeData')
class(`NodeData_path_len_get`) = c("SWIGFunction", class('NodeData_path_len_get'))

# Start of new_NodeData

`NodeData` = function()
{
  ;ans = .Call('R_swig_new_NodeData', PACKAGE='infomap');
  ans <- if (is.null(ans)) ans
  else new("_p_infomap__NodeData", ref=ans);
...
attr(`NodeData`, 'returnType') = '_p_infomap__NodeData'
class(`NodeData`) = c("SWIGFunction", class('NodeData'))
...
attr(`delete_NodeData`, "inputTypes") = c('_p_infomap__NodeData')
class(`delete_NodeData`) = c("SWIGFunction", class('delete_NodeData'))

# Start of accessor method for infomap::NodeData
setMethod('$', '_p_infomap__NodeData', function(x, name)

{
  accessorFuns = list('node_id' = NodeData_node_id_get, 'state_id' = NodeData_state_id_get, 'module_id' = NodeData_module_id_get, 'flow' = NodeData_flow_get, 'depth' = NodeData_depth_get, 'layer_id' = NodeData_layer_id_get, 'child_index' = NodeData_child_index_get, 'modular_centrality' = NodeData_modular_centrality_get, 'path_flat' = NodeData_path_flat_get, 'path_len' = NodeData_path_len_get);
  vaccessors = c('node_id', 'state_id', 'module_id', 'flow', 'depth', 'layer_id', 'child_index', 'modular_centrality', 'path_flat', 'path_len');
  ;        idx = pmatch(name, names(accessorFuns));
  if(is.na(idx)) 
  return(callNextMethod(x, name));
  f = accessorFuns[[idx]];
...
# end of accessor method for infomap::NodeData
# Start of accessor method for infomap::NodeData
setMethod('$<-', '_p_infomap__NodeData', function(x, name, value)

{
  accessorFuns = list('node_id' = NodeData_node_id_set, 'state_id' = NodeData_state_id_set, 'module_id' = NodeData_module_id_set, 'flow' = NodeData_flow_set, 'depth' = NodeData_depth_set, 'layer_id' = NodeData_layer_id_set, 'child_index' = NodeData_child_index_set, 'modular_centrality' = NodeData_modular_centrality_set, 'path_flat' = NodeData_path_flat_set, 'path_len' = NodeData_path_len_set);
  ;        idx = pmatch(name, names(accessorFuns));
  if(is.na(idx)) 
  return(callNextMethod(x, name, value));
  f = accessorFuns[[idx]];
...
setMethod('[[<-', c('_p_infomap__NodeData', 'character'),function(x, i, j, ..., value)
...
# end of accessor method for infomap::NodeData
setMethod('delete', '_p_infomap__NodeData', function(obj) {delete_infomap__NodeData(obj)})
# Start definition of copy functions & methods for infomap::NodeData
CopyToR_infomap__NodeData = function(value, obj = new("infomap::NodeData"))
{
  obj@node_id = value$node_id;
  obj@state_id = value$state_id;
  obj@module_id = value$module_id;
  obj@flow = value$flow;
  obj@depth = value$depth;
  obj@layer_id = value$layer_id;
  obj@child_index = value$child_index;
  obj@modular_centrality = value$modular_centrality;
  obj@path_flat = value$path_flat;
  obj@path_len = value$path_len;
  obj;
}



CopyToC_infomap__NodeData = function(value, obj)
{
  obj$node_id = value@node_id;
  obj$state_id = value@state_id;
  obj$module_id = value@module_id;
...
# Start definition of copy methods for infomap::NodeData
setMethod('copyToR', '_p_infomap__NodeData', CopyToR_infomap__NodeData);
setMethod('copyToC', 'infomap::NodeData', CopyToC_infomap__NodeData);

# End definition of copy methods for infomap::NodeData
# End definition of copy functions & methods for infomap::NodeData
...
# Dispatch function
# Start of InfomapWrapper_getNodeData

`InfomapWrapper_getNodeData__SWIG_0` = function(self, level, states, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  level = as.integer(level);
  ...
  states = as.logical(states);
  ;ans = .Call('R_swig_InfomapWrapper_getNodeData__SWIG_0', self, level, states, as.logical(.copy), PACKAGE='infomap');
  ans <- if (is.null(ans)) ans
  else new("_p_infomap__NodeData", ref=ans);
...
attr(`InfomapWrapper_getNodeData__SWIG_0`, 'returnType') = '_p_infomap__NodeData'
attr(`InfomapWrapper_getNodeData__SWIG_0`, "inputTypes") = c('_p_infomap__InfomapWrapper', 'integer', 'logical')
class(`InfomapWrapper_getNodeData__SWIG_0`) = c("SWIGFunction", class('InfomapWrapper_getNodeData__SWIG_0'))

# Start of InfomapWrapper_getNodeData

`InfomapWrapper_getNodeData__SWIG_1` = function(self, level, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  level = as.integer(level);
  ...
  ;ans = .Call('R_swig_InfomapWrapper_getNodeData__SWIG_1', self, level, as.logical(.copy), PACKAGE='infomap');
  ans <- if (is.null(ans)) ans
  else new("_p_infomap__NodeData", ref=ans);
...
attr(`InfomapWrapper_getNodeData__SWIG_1`, 'returnType') = '_p_infomap__NodeData'
attr(`InfomapWrapper_getNodeData__SWIG_1`, "inputTypes") = c('_p_infomap__InfomapWrapper', 'integer')
class(`InfomapWrapper_getNodeData__SWIG_1`) = c("SWIGFunction", class('InfomapWrapper_getNodeData__SWIG_1'))

# Start of InfomapWrapper_getNodeData

`InfomapWrapper_getNodeData__SWIG_2` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;ans = .Call('R_swig_InfomapWrapper_getNodeData__SWIG_2', self, as.logical(.copy), PACKAGE='infomap');
  ans <- if (is.null(ans)) ans
  else new("_p_infomap__NodeData", ref=ans);
...
attr(`InfomapWrapper_getNodeData__SWIG_2`, 'returnType') = '_p_infomap__NodeData'
attr(`InfomapWrapper_getNodeData__SWIG_2`, "inputTypes") = c('_p_infomap__InfomapWrapper')
class(`InfomapWrapper_getNodeData__SWIG_2`) = c("SWIGFunction", class('InfomapWrapper_getNodeData__SWIG_2'))

`InfomapWrapper_getNodeData` <- function(...) {
  argtypes <- mapply(class, list(...));
  argv <- list(...);
  argc <- length(argtypes);
  f <- NULL;
# dispatch functions 3
  if (argc == 1) {
    if ( extends(argtypes[1], '_p_infomap__InfomapWrapper') || is.null(argv[[1]]) ) {
      f <- InfomapWrapper_getNodeData__SWIG_2; 
    }
  } else if (argc == 2) {
    if (( extends(argtypes[1], '_p_infomap__InfomapWrapper') || is.null(argv[[1]]) ) && ( (is.integer(argv[[2]]) || is.numeric(argv[[2]])) && length(argv[[2]]) == 1 )) {
      f <- InfomapWrapper_getNodeData__SWIG_1; 
    }
  } else if (argc == 3) {
    if (( extends(argtypes[1], '_p_infomap__InfomapWrapper') || is.null(argv[[1]]) ) && ( (is.integer(argv[[2]]) || is.numeric(argv[[2]])) && length(argv[[2]]) == 1 ) && ( is.logical(argv[[3]]) && length(argv[[3]]) == 1 )) {
      f <- InfomapWrapper_getNodeData__SWIG_0; 
    }
  };
  if (is.null(f)) {
    stop("cannot find overloaded function for InfomapWrapper_getNodeData with argtypes (",toString(argtypes),")");
  };
  f(...);
}
