...
setClass("infomap::Config",
    representation(
        ...
        multilayerSkipAbsentNodes = "logical",
        intraRegularizationStrength = "numeric",
        interRegularizationStrength = "numeric",
...
# Start of Config_multilayerSkipAbsentNodes_set

`Config_multilayerSkipAbsentNodes_set` = function(self, s_multilayerSkipAbsentNodes)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_multilayerSkipAbsentNodes = as.logical(s_multilayerSkipAbsentNodes);
  ;.Call('R_swig_Config_multilayerSkipAbsentNodes_set', self, s_multilayerSkipAbsentNodes, PACKAGE='infomap');
  
}

attr(`Config_multilayerSkipAbsentNodes_set`, 'returnType') = 'void'
attr(`Config_multilayerSkipAbsentNodes_set`, "inputTypes") = c('_p_infomap__Config', 'logical')
class(`Config_multilayerSkipAbsentNodes_set`) = c("SWIGFunction", class('Config_multilayerSkipAbsentNodes_set'))

# Start of Config_multilayerSkipAbsentNodes_get

`Config_multilayerSkipAbsentNodes_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_multilayerSkipAbsentNodes_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_multilayerSkipAbsentNodes_get`, 'returnType') = 'logical'
attr(`Config_multilayerSkipAbsentNodes_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_multilayerSkipAbsentNodes_get`) = c("SWIGFunction", class('Config_multilayerSkipAbsentNodes_get'))

# Start of Config_intraRegularizationStrength_set

`Config_intraRegularizationStrength_set` = function(self, s_intraRegularizationStrength)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  
  ;.Call('R_swig_Config_intraRegularizationStrength_set', self, s_intraRegularizationStrength, PACKAGE='infomap');
  
}

attr(`Config_intraRegularizationStrength_set`, 'returnType') = 'void'
attr(`Config_intraRegularizationStrength_set`, "inputTypes") = c('_p_infomap__Config', 'numeric')
class(`Config_intraRegularizationStrength_set`) = c("SWIGFunction", class('Config_intraRegularizationStrength_set'))

# Start of Config_intraRegularizationStrength_get

`Config_intraRegularizationStrength_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_intraRegularizationStrength_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_intraRegularizationStrength_get`, 'returnType') = 'numeric'
attr(`Config_intraRegularizationStrength_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_intraRegularizationStrength_get`) = c("SWIGFunction", class('Config_intraRegularizationStrength_get'))

# Start of Config_interRegularizationStrength_set

`Config_interRegularizationStrength_set` = function(self, s_interRegularizationStrength)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  
  ;.Call('R_swig_Config_interRegularizationStrength_set', self, s_interRegularizationStrength, PACKAGE='infomap');
  
}

attr(`Config_interRegularizationStrength_set`, 'returnType') = 'void'
attr(`Config_interRegularizationStrength_set`, "inputTypes") = c('_p_infomap__Config', 'numeric')
class(`Config_interRegularizationStrength_set`) = c("SWIGFunction", class('Config_interRegularizationStrength_set'))

# Start of Config_interRegularizationStrength_get

`Config_interRegularizationStrength_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_interRegularizationStrength_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_interRegularizationStrength_get`, 'returnType') = 'numeric'
attr(`Config_interRegularizationStrength_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_interRegularizationStrength_get`) = c("SWIGFunction", class('Config_interRegularizationStrength_get'))
...
CopyToR_infomap__Config = function(value, obj = new("infomap::Config"))
{
  ...
  obj@multilayerSkipAbsentNodes = value$multilayerSkipAbsentNodes;
  obj@intraRegularizationStrength = value$intraRegularizationStrength;
  obj@interRegularizationStrength = value$interRegularizationStrength;
