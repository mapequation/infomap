...
setClass("infomap::Config",
    representation(
        ...
        solutionLandscapeTracking = "logical",
        solutionLandscapeStopAfter = "integer",
...
# Start of Config_solutionLandscapeTracking_set

`Config_solutionLandscapeTracking_set` = function(self, s_solutionLandscapeTracking)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_solutionLandscapeTracking = as.logical(s_solutionLandscapeTracking);
  ;.Call('R_swig_Config_solutionLandscapeTracking_set', self, s_solutionLandscapeTracking, PACKAGE='infomap');
  
}

attr(`Config_solutionLandscapeTracking_set`, 'returnType') = 'void'
attr(`Config_solutionLandscapeTracking_set`, "inputTypes") = c('_p_infomap__Config', 'logical')
class(`Config_solutionLandscapeTracking_set`) = c("SWIGFunction", class('Config_solutionLandscapeTracking_set'))

# Start of Config_solutionLandscapeTracking_get

`Config_solutionLandscapeTracking_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_solutionLandscapeTracking_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_solutionLandscapeTracking_get`, 'returnType') = 'logical'
attr(`Config_solutionLandscapeTracking_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_solutionLandscapeTracking_get`) = c("SWIGFunction", class('Config_solutionLandscapeTracking_get'))

# Start of Config_solutionLandscapeStopAfter_set

`Config_solutionLandscapeStopAfter_set` = function(self, s_solutionLandscapeStopAfter)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  s_solutionLandscapeStopAfter = as.integer(s_solutionLandscapeStopAfter);
  
  if(length(s_solutionLandscapeStopAfter) > 1) {
    warning("using only the first element of s_solutionLandscapeStopAfter");
  };
  
  ;.Call('R_swig_Config_solutionLandscapeStopAfter_set', self, s_solutionLandscapeStopAfter, PACKAGE='infomap');
  
}

attr(`Config_solutionLandscapeStopAfter_set`, 'returnType') = 'void'
attr(`Config_solutionLandscapeStopAfter_set`, "inputTypes") = c('_p_infomap__Config', 'integer')
class(`Config_solutionLandscapeStopAfter_set`) = c("SWIGFunction", class('Config_solutionLandscapeStopAfter_set'))

# Start of Config_solutionLandscapeStopAfter_get

`Config_solutionLandscapeStopAfter_get` = function(self, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref"); 
  ;.Call('R_swig_Config_solutionLandscapeStopAfter_get', self, as.logical(.copy), PACKAGE='infomap');
  
}

attr(`Config_solutionLandscapeStopAfter_get`, 'returnType') = 'integer'
attr(`Config_solutionLandscapeStopAfter_get`, "inputTypes") = c('_p_infomap__Config')
class(`Config_solutionLandscapeStopAfter_get`) = c("SWIGFunction", class('Config_solutionLandscapeStopAfter_get'))
...
CopyToR_infomap__Config = function(value, obj = new("infomap::Config"))
{
  ...
  obj@solutionLandscapeTracking = value$solutionLandscapeTracking;
  obj@solutionLandscapeStopAfter = value$solutionLandscapeStopAfter;
